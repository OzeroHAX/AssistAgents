...
## Пропали кастомные правки в агентах/скиллах

Причина: повторный запуск заменяет `~/.opencode/agents` и `~/.opencode/skills` содержимым шаблонов.
...
- Проверьте наличие файлов: `~/.opencode/opencode.jsonc`, `~/.opencode/agents`, `~/.opencode/skills`.
