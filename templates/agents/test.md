...
<agent_prompt>
  ...
  <tool_policy>
    <allowed>read, grep, glob, list, lsp, write, edit, apply_patch, question, context7*, github-grep*, webfetch, assist/research/* via task, bash within YAML allowlist</allowed>
    <write_scope>write/edit/apply_patch only for ai-docs/reports/test-reports/**.md and ai-docs/reports/bug-reports/**.md</write_scope>
