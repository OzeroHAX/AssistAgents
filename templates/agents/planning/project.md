...
<mandatory_rules>
  ...
  <rule>ALWAYS check whether ai-docs/project/arch/architecture.md exists (via glob). If it exists, read it early as context for architecture decisions.</rule>
...
<workflow>
  ...
  <step>1.1 Check for ai-docs/project/arch/architecture.md via glob; if present, read it early as default architecture context.</step>
